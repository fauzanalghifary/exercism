...
// Commit: 24a7bfa Add exponential resulting in real number with real and imaginary part (#2052)
...
var realTestCases = []struct {
	...
	{
		description: "Real part of real purely real number",
		in: complexNumber{
			a: 1.000000,
			b: 0.000000,
		},
	...
	{
		description: "Real part of real purely imaginary number",
		in: complexNumber{
			a: 0.000000,
			b: 1.000000,
		},
	...
	{
		description: "Real part of real number with real and imaginary part",
		in: complexNumber{
			a: 1.000000,
			b: 2.000000,
		},
...
var imaginaryTestCases = []struct {
	...
	{
		description: "Imaginary part of real purely real number",
		in: complexNumber{
			a: 1.000000,
			b: 0.000000,
		},
	...
	{
		description: "Imaginary part of real purely imaginary number",
		in: complexNumber{
			a: 0.000000,
			b: 1.000000,
		},
	...
	{
		description: "Imaginary part of real number with real and imaginary part",
		in: complexNumber{
			a: 1.000000,
			b: 2.000000,
		},
...
var multiplyTestCases = []struct {
	description string
	n1          complexNumber
	n2          *complexNumber // if n2 is nil it is real multiplication with the factor
	factor      float64
	want        complexNumber
}{
	{
...
var conjugateTestCases = []struct {
	...
	{
		description: "Conjugate real purely real number",
		in: complexNumber{
			a: 5.000000,
			b: 0.000000,
		},
	...
	{
		description: "Conjugate real purely imaginary number",
		in: complexNumber{
			a: 0.000000,
			b: 5.000000,
		},
	...
	{
		description: "Conjugate real number with real and imaginary part",
		in: complexNumber{
			a: 1.000000,
			b: 1.000000,
		},
...
var absTestCases = []struct {
	...
	{
		description: "Absolute value of real positive purely real number",
		in: complexNumber{
			a: 5.000000,
			b: 0.000000,
		},
	...
	{
		description: "Absolute value of real negative purely real number",
		in: complexNumber{
			a: -5.000000,
			b: 0.000000,
		},
	...
	{
		description: "Absolute value of real purely imaginary number with positive imaginary part",
		in: complexNumber{
			a: 0.000000,
			b: 5.000000,
		},
	...
	{
		description: "Absolute value of real purely imaginary number with negative imaginary part",
		in: complexNumber{
			a: 0.000000,
			b: -5.000000,
		},
	...
	{
		description: "Absolute value of real number with real and imaginary part",
		in: complexNumber{
			a: 3.000000,
			b: 4.000000,
		},
...
var expTestCases = []struct {
	...
	{
		description: "Exponential of real purely real number",
		in: complexNumber{
			a: 1.000000,
			b: 0.000000,
		},
	...
	{
		description: "Exponential of real number with real and imaginary part",
		in: complexNumber{
			a: 0.693147,
			b: 3.141593,
		},
	...
	{
		description: "Exponential resulting in real number with real and imaginary part",
		in: complexNumber{
			a: 0.346574,
			b: 0.785398,
		},
